                ...
                <div class="row">
                    <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="error-section">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Lock_font_awesome.svg/1200px-Lock_font_awesome.svg.png " width="300px" heigth="200px" alt="" class="img-fluid">
                            <div class="error-section-content">
                                <h1 class="display-3">You Have No Accsess For This Page</h1>
