						...
						<div class="row contact_left_grid">
                            ...
                            <p class="sub text-center mb-lg-5 mb-3">Edit your profile</p> <br><br>
								...
								<div class="form-group">
									...
									<input class="form-control" type="password" name="customer_password" placeholder="" required="" value= "<?php echo $row['customer_password']?>">
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <input class="form-control" type="submit" value="Update"><br><br><br>
							</div>
