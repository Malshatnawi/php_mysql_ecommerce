						...
						<form action="" method="post" class="creditly-card-form agileinfo_form">
							<section class="creditly-wrapper wrapper">
								<div class="information-wrapper">
										...
										<div class="card_number_grids">
											...
											<div class="card_number_grid_right">
												<div class="controls">
													...
													<input class="form-control" type="text" placeholder="Landmark" name="shippingaddress">
												</div>
											</div>
											<!-- <div class="clear"> </div> -->
                                        </div>
                                    ...
                                    <div  >
                                            <label for="payment"> Cach On Delivery</label> 
                                            <input type="checkbox" id="payment" name="payment" value="">   
                                            </div>
									<button class="submit check_out" name="submit">Delivery to this Address</button>
								</div>
							</section>
						</form>
