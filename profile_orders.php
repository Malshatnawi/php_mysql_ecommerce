				...
				<div class="col-md-3 top-info text-left mt-lg-4">
                    ...
                    <li class="">
							<form action="#" method="post" class="last">
                                <?php 
                                if(isset($_SESSION['customer'])){
                                    echo "<button>  <a href='http://localhost/E-Commerce%20Website%20PHP%20and%20MYSQL/CODE/ECOMMERCE-PUBLIC/goggles-web_Free07-08-2018_1255464790/web/profile_update.php'>Update Your Profile</a> 
                                    </button>";
